...
function Feature() {
    ...
    return (
        <div className='w-full py-20 flex items-center flex-col'>
            ...
            <div className='px-20 flex flex-col gap-20'>
                <div className="cards w-full flex gap-10 mt-10">
                    <div className="cardContainer relative w-1/2 h-[80vh]">
                        ...
                        <motion.div onHoverEnd={() => handleHoverEnd(0)} onHoverStart={() => handleHover(0)} onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)} className="hover:p-1 ease-linear duration-150">
                        ...
                        <div className='flex items-start gap-3 py-4'>
                            <span className='px-3 py-1 border border-white rounded-full text-white text-xs'>PITCH DECK</span>
                            <span className='px-3 py-1 border border-white rounded-full text-white text-xs'>PITCH DECK</span>
                            <span className='px-3 py-1 border border-white rounded-full text-white text-xs'>PITCH DECK</span>
                        </div>
                    </div>
                    <div className="cardContainer relative w-1/2 h-[80vh]">
                        ...
                        <motion.div onHoverEnd={() => handleHoverEnd(1)} onHoverStart={() => handleHover(1)} onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)} className="hover:p-1 ease-linear duration-150 ">
                ...
                <div className="cards w-full flex gap-10 mt-10">
                    <div className="cardContainer relative w-1/2 h-[80vh]">
                        ...
                        <motion.div onHoverEnd={() => handleHoverEnd(2)} onHoverStart={() => handleHover(2)} onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)} className="hover:p-1 ease-linear duration-150">
                            <h1 className="absolute flex text-[#CDEA68] left-full text-[150px] z-10 overflow-hidden leading-none tracking-tighter -translate-x-1/2 top-1/2 -translate-y-1/2 font-[founders Grotesk">
                                {"TRAWA".split('').map((item, index) => <motion.span initial={{ y: "100%" }} transition={{ ease: [0.22, 1, 0.36, 1], delay: index * .01 }} animate={cards[2]} className='inline-block '>{item}</motion.span>)}
                    ...
                    <div className="cardContainer relative w-1/2 h-[80vh]">
                        ...
                        <motion.div onHoverEnd={() => handleHoverEnd(3)} onHoverStart={() => handleHover(3)} onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)} className="hover:p-1 ease-linear duration-150 ">
                            <h1 className="absolute flex overflow-hidden text-[#CDEA68] right-full text-[150px] leading-none tracking-tighter translate-x-1/2 top-1/2 -translate-y-1/2 font-[founders Grotesk">
                                {"PREMIUM BLEND".split('').map((item, index) => <motion.span initial={{ y: "100%" }} transition={{ ease: [0.22, 1, 0.36, 1], delay: index * .01 }} animate={cards[3]} className='inline-block'>{item}</motion.span>)}
            ...
            <span className='px-3 py-2  border mt-40 flex items-center gap-5 rounded-full  border-white '>VIEW ALL CASESTUDIES 
                <span className='p-1 bg-white flex rounded-full'></span>
            </span>
        </div>
    )
}
