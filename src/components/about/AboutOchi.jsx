...
import AboutMarque from "./AboutMarque";
          ...
          <div className="w-[50vw] flex items-start justify-between ">
            <div className="flex w-[22vw] text-justify flex-col items-start gap-5">
              ...
              <div>
                ...
                business results far better than any saying can. Hence, we
                founded ochi to help you persuade colleagues and clients by
                creating eye-opening presentations.
              </div>
            </div>
